...
const VehiclesHero: React.FC = () => {
    ...
    {/* Scroll Down Arrow - Now placed normally in the flow, not absolutely positioned */}
...
// Enhanced Filter Bar Component with Your Theme Colors
                    ...
                    {activeFiltersCount > 0 && (
                        <div className="flex items-center gap-3 flex-wrap">
                            ...
                            {Object.entries(filters).map(([key, value]) => {
                                ...
                                return filterValue && filterKey !== 'search' && (
                                    <span 
                                        key={filterKey}
                                        className="bg-orange-100 text-orange-800 px-4 py-2 rounded-full text-sm font-semibold flex items-center gap-2 border border-orange-200"
                                    >
                        ...
                        {vehicles.map((vehicle) => (
                            <div key={vehicle.vehicle_id} className="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden hover:shadow-xl transition-all duration-300 group hover:border-orange-200">
                                ...
                                <div className="relative h-48 overflow-hidden">
                                    <img 
                                        src={vehicle.specification.image_url || 'https://images.unsplash.com/photo-1549317661-bd32c8ce0db2?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1170&q=80'}
                                    ...
                                    />
                                    <div className={`absolute top-4 left-0 px-3 py-1 rounded-r-full text-xs font-bold text-white ${
